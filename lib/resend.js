...
export async function sendBookingConfirmation({ booking, occasion }) {
  ...
  await deliver({
    ...
    html: shell(`
      ...
      <p style="color:#888;font-size:13px">Your deposit is non-refundable, but it moves with your booking if you pick another date. Prefer to talk? WhatsApp us on 061 489 4615.</p>
    `),
  })
}
