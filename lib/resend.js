...
async function deliver(args) {
  ...
  const method = resolveMethod(args?.settings ?? (await loadSettings()))
  const result = await deliverInner(args)
  ...
  await deliver({
    ...
    html: shell(`
      ...
      <div style="text-align:center;margin:28px 0">
        <a href="${(process.env.NEXT_PUBLIC_SITE_URL || 'https://khulacafe.vercel.app')}/booking/${booking.id}"
